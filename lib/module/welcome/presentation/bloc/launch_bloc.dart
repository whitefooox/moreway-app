...
class LaunchBloc extends Bloc<LaunchEvent, LaunchState> {
  ...
  final SendRequestLocationPermissionUseCase _sendRequestLocationPermissionUseCase;

  LaunchBloc(
    this._checkFirstLaunchUseCase,
    this._setStatusFirstLaunchUseCase,
  ...
  void _markFirstLaunch(
    SetFirstStatusLaunchEvent event, 
    Emitter<LaunchState> emit
  ) async {
